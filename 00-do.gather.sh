...
perl m@th.[deep].pl -augmented -w2v "$vector" -dict source/dict/2014wiki_full_subset.dict.bz2 -cluster 2>> debug/gather.full.m@th.aug.txt
vector="source/clusters/wikipedia+.c3000.cls.bz2"
perl m@th.[deep].pl -w2v "$vector" -dict source/dict/2014wiki_full_subset.dict.bz2 -cluster 2>> debug/gather.full.m@th.orig.txt
